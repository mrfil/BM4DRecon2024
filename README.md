This code applies the BM4D reconstruction algorithm originally developed from [1] and applies it to a spiral acquisition [2] sampled on non-cartesian coordinates. 
